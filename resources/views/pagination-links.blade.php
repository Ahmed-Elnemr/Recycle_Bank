...
<ul class="flex justify-between">
    ...
    @else
    <li class="w-16 px-2 py-1 text-center rounded border shadow bg-white cursor-pointer" wire:click="previousPage">السابق</li>
    @endif
    <!-- prev end -->
    ...
    <li class="w-16 px-2 py-1 text-center rounded border shadow bg-white cursor-pointer" wire:click=" nextPage  ">التالي</li>
    @else
    <li class="w-16 px-2 py-1 text-center rounded border bg-gray-200">التالي</li>
    @endif
    <!-- next end -->
</ul>
@endif
